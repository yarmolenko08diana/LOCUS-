...
export const DEMO_CASES: DemoCase[] = [
  {
    ...
    profile: {
      ...
      achievements: [
        { id: 'high-1', kind: 'olympiad', level: 'international', award: 'silver', title: 'Международная олимпиада по информатике', year },
        { id: 'high-2', kind: 'research', level: 'national', award: 'gold', title: 'Республиканский конкурс научных проектов', year: year - 1 },
        { id: 'high-3', kind: 'hackathon', level: 'national', award: 'finalist', title: 'Финал республиканского хакатона', year },
        { id: 'high-4', kind: 'leadership', level: 'school', award: 'participant', title: 'Президент школьного совета', year, hours: 120 },
      ],
  ...
  },
  {
    ...
    profile: {
      ...
      achievements: [
        { id: 'med-1', kind: 'olympiad', level: 'city', award: 'bronze', title: 'Городская олимпиада по физике', year: year - 1 },
        { id: 'med-2', kind: 'volunteer', level: 'school', award: 'participant', title: 'Помощь в школьной робототехнической секции', year, hours: 40 },
      ],
